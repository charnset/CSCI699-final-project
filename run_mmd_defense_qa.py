...
def create_dataset(dataset, sampling_size):
...
def extract_dir(training_file, directory_i, directory_o, directory_a):
    test_dataset_s = {} #RANDOM, WIKI, BENIGN

    attack_file_s = [os.path.join(directory_a, f) for f in os.listdir(directory_a) if "dev" in f]
    #print(attack_file_s)
...
if __name__ == "__main__":
    ...
    extract_dir(args.b, args.i, args.o, args.a)
