...
def extract_dir(training_dataset_name="tweet_eval"):
    for i, testing_dataset_name in enumerate(dataset_list):
        data_x = read_data(training_dataset_name)
        data_y = read_data(testing_dataset_name)
        logger.info("Reading {} ...".format(training_dataset_name))
        logger.info("Number of questions: {}".format(data_x.num_rows))
        logger.info("Reading {} ...".format(testing_dataset_name))
        ...
        logger.info("Embedding {} ...".format(testing_dataset_name))
